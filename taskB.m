...
close all
clc
file_path =  'D:\study\4\ELEC0134_AMLS\AMLS-2021_dataset\dataset\image\';   % Input images
fileID = fopen('D:\study\4\ELEC0134_AMLS\AMLS-2021_dataset\dataset\label.csv'); % Input name of images and types of tumor
...
% file_path1 =  'D:\study\4\ELEC0134_AMLS\AMLS-2021_test\test\image\';   % Input images
% fileID1 = fopen('D:\study\4\ELEC0134_AMLS\AMLS-2021_test\test\label.csv'); % Input name of images and types of tumor
...
for i = 1:Num_test
    predicts(i) = kNNClassifier(data_test(i,:),data_train,label_train,Num_close_point);
end
